...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\ub8ljw\\source\\repos\\zh3\\ub8ljw_zh3\\ub8ljw_zh3\\StudiesDatabase.mdf;Integrated Security=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Course>(entity =>
        {
            entity.HasKey(e => e.CourseSk).HasName("PK__Course__C92D8C48690EDE56");
        ...
        {
            entity.HasKey(e => e.DayId).HasName("PK__Day__BF3DD82512603EDB");
        ...
        {
            entity.HasKey(e => e.EmployementId).HasName("PK__Employem__BFBFF07683E3D4D1");
        ...
        {
            entity.HasKey(e => e.InstructorSk).HasName("PK__Instruct__9D017A28A7DCE847");
        ...
        {
            entity.HasKey(e => e.LessonSk).HasName("PK__Lesson__B08512E2402FD66A");
        ...
        {
            entity.HasKey(e => e.RoomSk).HasName("PK__Room__328616CFC3C693DA");
        ...
        {
            entity.HasKey(e => e.StatusId).HasName("PK__Status__C8EE2043A17BF025");
        ...
        {
            entity.HasKey(e => e.TimeId).HasName("PK__Time__E04ED967DE19FBA1");
